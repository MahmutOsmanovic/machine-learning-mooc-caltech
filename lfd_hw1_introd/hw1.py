...
# n = <-(y2-y1),(x2-x1)> in this case. u = dot(n,D) 
...
def runSimulation(numberOfTrials, numberOfTestPoints, iterationLimit): #1000,10,100
    interations = []
    probability = []
...
def runTrial(numberOfTestPoints, iterationLimit, showChart = False): #10,100
    x1, y1, x2, y2, points = generatePoints(numberOfTestPoints)
    iterations, w = train(points, iterationLimit) #9,100
